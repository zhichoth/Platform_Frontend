      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div class="mt-8 pd-10 md:mt-0 md:order-1">
          ...
          <p class="text-left text-base text-gray-400">
            Buy our developers a 🍺: <a href="https://etherscan.io/address/0x7482B336283041386942fC106Fd47F99976D1A06" target="_blank" class="text-blue-500 hover:text-yellow-600 transiation duration-300">0x7482B336283041386942fC106Fd47F99976D1A06</a>
          </p>
        </div>
      </div>
    </footer>
